...
const deletedVideoInfo = (props) => (<View style={inlineStyles.container}>
                    <TouchableOpacity onPressOut={()=>props.navigation.goBack()} style={inlineStyles.historyBackSkipFont}>
